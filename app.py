...
def get_locale():
    if 'lang' in session:
        return session['lang']
    # Tarayıcı dilinden bağımsız olarak varsayılan dili Türkçe yapıyoruz
    return 'tr'
...
def check_auth():
    ...
    if 'user_id' in session:
        ...
        admin_only_endpoints = [
            ...
            'sync_page', 'veriler_sayfasi', 'muhasebe', 'muhasebe_analyze', 'api_fetch_mail', 'api_save_mail_settings'
        ]
